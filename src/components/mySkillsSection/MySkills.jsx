        ...
        <div className="flex flex-wrap w-full md:pr-4 md:w-1/2">
          ...
          <div className="flex-auto col-auto text-center md:ml-20 md:text-right">
            <span className="font-bold font-sans">
              I am proficient in Typescript, Java, and SQL with experience in
              Vue and React. I have also completed projects which use Docker,
              Terraform, Kubernetes, Python and C++. My interests lie within
              Fintech, Web Applications, Cloud Architectures.
            </span>
          </div>
        </div>
